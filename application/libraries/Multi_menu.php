...
class Multi_menu {
	...
	/**
	 * Opening tag of menu label
	 * Default is ''
	 * 
	 * @var string
	 */
	private $label_tag_open        = '';

	/**
	 * Closing tag of menu label
	 * Default is ''
	 * 
	 * @var string
	 */
	private $label_tag_close       = '';

	/**
	 * Icon class for item that has children
	 * Default is ''
	 * 
	 * @var string
	 */
	private $has_children_icon       = '';
	...
	{	    
	    ...
	    foreach ($items as $item)
	    {
	        ...
	        if ( isset($item[$this->menu_label], $item[$this->menu_key]) ) 
	        {
				...
				$label = $this->label_tag_open . $item[$this->menu_label];
				if ($has_children)
				{
					$label .= "<i class='{$this->has_children_icon}'></i>";
				}
				$label .= $this->label_tag_close;
		        ...
		        if ($icon) 
		        {
		        	$icon = "<i class='{$this->menu_icon_prefix} {$icon}'></i>";

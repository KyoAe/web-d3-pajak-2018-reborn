...
class Example extends CI_Controller {
    ...
    public function index() {
        ...
        // if($this->aauth->is_loggedin('admin@example.com'))
        // {
        //     echo "Hellowwww";
        // }
        // else
        ...
        //     echo "NOOOOO";
        // }
        $password = $this->db->get_where('users', ['email' => 'admin@example.com'])->row()->pass;
        // var_dump(password_verify('12345', $password));
        var_dump($this->aauth->login('admin@example.com', '12345'));
        // if ()
        //     echo 'tmm';
        // else
        //     echo 'hyr';
        // echo date("Y-m-d H:i:s");
        // var_dump($this->aauth->unban_user(1));
        // var_dump($this->aauth->reset_login_attempts());
        echo "<br/>";

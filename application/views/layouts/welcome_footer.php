...
<script>
	...
	var countDownDate = new Date("Oct 27, 2021 00:00:00").getTime();
	...
	// Display the result in the element with id="countdown-wisuda"
	if (distance > 0)
	{
		document.getElementById("countdown-wisuda").innerHTML = days + " Hari " + hours + " Jam "
	...
	if (days < -1) {
		clearInterval(x);
		document.getElementById("countdown-wisuda").innerHTML = "SELESAII";
	}
	}, 1000);
</script>
</body>
